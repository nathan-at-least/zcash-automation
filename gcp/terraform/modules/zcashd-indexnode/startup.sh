...
DISK_PATH=$(readlink -f /dev/disk/by-id/google-${index_data_disk_name})
DATA_DIR=/home/zcash/.zcash

echo "Setting up persistent disk ${index_data_disk_name} at $DISK_PATH..."
...
# ---- Config /etc/tmux.conf ----
echo "Configuring /etc/tmux.conf" | logger
